    ...
    feasibilities: {
      ...
      text: [
...

        {
          ...
          coords: { top: 0, left: 23.4 },
        },

        {
          title: "treatment standards & practices",
          paragraph:
            "We research treatment standards and practices across different regions, countries and sites. Understanding how these variations may impact recruitment, enrollment, can critically affect overall study outcomes.",
          coords: { top: 16.4, left: 23.4 },
        },

        {
          ...
          paragraph:
            "One of the keys of stand-alone feasibility is the recruitment analysis. MICRO will evaluate investigator candidate's suitability, experience, potential and motivation for your trial. We also gauge motivation of patients to take part and stay compliant throughout study. ",
          coords: { top: 16.4, left: -6.5 },
        },
      ...
      text: [
        {
          ...
          paragraph:
            "We'll assist you in managing funding and legal agreements in support to study execution. It includes budget preparation, contract negotiation, compliance with regulations, timely approvals, and financial monitoring for smooth trial operations and sponsor satisfaction.",
          coords: { top: 16.4, left: -6.5 },
        },
        {
    ...
    authorities: {
      ...
      text: [
        ...
        },
        {
          ...
          paragraph:
            "Clinical trial submissions involve preparing and submitting detailed protocols, informed consent forms, and safety data to regulatory authorities and ethics committees. Approvals are granted after thorough scientific and ethical reviews.",
          coords: { top: 0, left: -6.5 },
        },
        {
    ...
    monitoring: {
      ...
      text: [
        ...
        },
        {
          ...
          paragraph:
            "A CT initiation visit (SIV) confirms site readiness for trial start. It reviews protocols, regulatory approvals, staff training, study materials, monitoring plans, recruitment strategies, and communication with key site staff, in compliance with Good Clinical Practice (GCP) .",
          coords: { top: 0, left: -6.5 },
        },
        {
          title: "interim visits",
          paragraph:
            "Interim visits are conducted during the study to ensure protocol compliance, verify data accuracy, protect patient safety, and monitor regulatory adherence. They involve document review, source data verification, and addressing site queries maintaining study integrity ",
          coords: { top: 0, left: 23.4 },
        },
        {
